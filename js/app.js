...
function updateAdminUI() {
  ...
  if (isAdmin()) { dot.className = 'dot-online'; newLogBtn.classList.remove('hidden'); fieldConfigBtn.classList.remove('hidden'); }
  else { dot.className = 'dot-offline'; newLogBtn.classList.add('hidden'); fieldConfigBtn.classList.add('hidden'); }
  renderLogs();
}
